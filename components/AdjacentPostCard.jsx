...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    <div className="flex flex-col rounded-lg p-4 items-center justify-center absolute w-full h-full ">
      ...
      <span className="text-white text-sm">{moment(post.createdAt).format('MMM DD, YYYY')}</span>
<span className="text-white text-sm">{moment(post.createdAt).startOf('hour').fromNow()}</span>
